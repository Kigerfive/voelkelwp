...
function coral_dark_customize_register( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'blogname', array(
		...
		'render_callback' => 'coral_dark_customize_partial_blogname',
	) );
	$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
		'selector' => '.site-description',
		'render_callback' => 'coral_dark_customize_partial_blogdescription',
	) );
 ...
 * @return void
 */
function coral_dark_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function coral_dark_customize_partial_blogdescription() {
