<?php
/**
 * Bistro Lite Theme Customizer
 *
 * @package Bistro Lite
 */
 
function bistro_lite_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'bistro_lite_custom_header_args', array(
...
endif; // bistro_lite_header_style 
 ...
 * @param WP_Customize_Manager $wp_customize Theme Customizer object.
 */
function bistro_lite_customize_register( $wp_customize ) {
	
	//Add a class for titles
    class bistro_lite_Info extends WP_Customize_Control {
        public $type = 'info';
        public $label = '';
...
function bistro_lite_custom_css(){
		...
		?>
        	<style type="text/css"> 					
					...
					{color:<?php echo esc_attr(get_theme_mod('color_scheme','#ff8800')); ?>;}
					...
					a.ReadMore,
					input.search-submit
					{ background-color:<?php echo esc_attr(get_theme_mod('color_scheme','#ff8800')); ?> !important;}

					#menubar,
					h2.section-title::after,
					h2.section-title
					{ border-color:<?php echo esc_attr(get_theme_mod('color_scheme','#ff8800')); ?>;}
...
add_action('wp_head','bistro_lite_custom_css');	         

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function bistro_lite_customize_preview_js() {
	wp_enqueue_script( 'bistro_lite_customizer', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20130508', true );
}
add_action( 'customize_preview_init', 'bistro_lite_customize_preview_js' );